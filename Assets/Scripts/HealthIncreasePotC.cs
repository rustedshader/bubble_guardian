...
public class HealthIncreasePotC : MonoBehaviour
{
    public int healthIncreaseAmount = 10; // Amount of health to increase when the chest is opened
    ...
    private void OpenChest()
    {
        ...
        else
        {
            ...
            Debug.Log("Pot C opened! Health increased.");
        }
    } 
}
